...
export class ContentService {
  ...
  async getTestimonialById(id: string) {
    return await this.testimonialRepo.findById(id);
  }
  ...
  async updateTestimonial(id: string, data: UpdateTestimonialDto) {
    const { image_removed, image_base64, ...updateFields } = data as any;
    ...
    if (image_removed) {
      ...
      testimonial.image_base64 = image_base64 ?? testimonial.image_base64 ?? "";
    }
